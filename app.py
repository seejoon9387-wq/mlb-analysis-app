...
st.title("⚾ MLB 최종 통합 분석기 (한글/영문 보정 완료)")
...
if st.button("최종 분석 실행"):
    st.success("데이터 보정 완료 및 분석 수행 중...")
    st.info("환경 변수(홈 이점 4% 및 야간 경기 가중치)가 반영되었습니다.")
...
st.sidebar.write("---")
st.sidebar.caption("※ 띄어쓰기가 틀려도 선수 이름이 자동 보정됩니다.")
